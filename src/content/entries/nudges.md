---
title: "Nudges"
oneLiner: "Subtle changes to the choice environment that steer behaviour without restricting options"
alsoKnownAs: ["Choice architecture", "Libertarian paternalism", "Default design"]
...
related:
  ...
  - slug: "leverage-points"
    note: "Nudges operate at a specific leverage point - the information and choice architecture that shapes decisions"
  - slug: "feedback-loops"
    note: "Many effective nudges work by making feedback visible that was previously hidden"
  - slug: "second-order-effects"
    note: "Nudges can produce second-order effects - changing one default can shift behaviour patterns well beyond the original choice"
  - slug: "policy-resistance"
    note: "Nudges often meet less resistance than mandates because they don't restrict freedom - they redirect attention"
originatedBy: "Richard Thaler and Cass Sunstein"
draft: false
---
