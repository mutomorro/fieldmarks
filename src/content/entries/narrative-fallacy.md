...
oneLiner: "The need to construct a simple story from complex events - makes us feel like we understand, even when we don't"
alsoKnownAs: ["Storytelling bias", "Narrative bias", "Post-hoc storytelling"]
...
related:
  ...
  - slug: "hindsight-bias"
    note: "Hindsight bias feeds the narrative fallacy - once you know the ending, constructing the story is easy and misleading"
  - slug: "sensitivity-to-initial-conditions"
    note: "The narrative fallacy ignores sensitivity to initial conditions - the story makes the outcome seem inevitable when it was contingent"
  - slug: "complexity-vs-complication"
    note: "The narrative fallacy reduces complex events to complicated ones - a neat story with clear causes and effects"
  - slug: "mental-models"
    note: "Narratives build and reinforce mental models - the stories we tell about what happened shape what we expect to happen next"
draft: false
---
