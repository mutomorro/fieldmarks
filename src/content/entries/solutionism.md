---
title: "Solutionism"
oneLiner: "The assumption that every problem has a clean solution - when complex systems often need navigation, not fixing"
alsoKnownAs: ["Fix-it mentality", "The engineering fallacy"]
theme: "mental-models"
tags: ["thinking", "complexity", "problem-solving", "design"]
dotGrid:
  seed: 3527
  variant: "fixesThatFail"
related:
  - slug: "wicked-problems"
    note: "Solutionism is the refusal to accept that wicked problems exist - treating every messy situation as a puzzle to be solved"
  - slug: "complexity-vs-complication"
    note: "Solutionism treats complex problems as merely complicated - assuming they have clean answers if you think hard enough"
  - slug: "fixes-that-fail"
    note: "Solutionism produces fixes that fail because it demands a solution before the problem is properly understood"
