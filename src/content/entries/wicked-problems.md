...
oneLiner: "Problems that resist definition, change shape when you try to solve them, and have no stopping rule"
alsoKnownAs: ["Ill-structured problems", "Messy problems"]
...
related:
  ...
  - slug: "cynefin-framework"
    note: "Wicked problems sit in Cynefin's complex domain - requiring probes and emergence, not analysis and plans"
  - slug: "boundaries"
    note: "Wicked problems resist boundary-drawing - every definition of the problem excludes something that turns out to matter"
  - slug: "unintended-consequences"
    note: "Every attempt to solve a wicked problem produces unintended consequences that reshape the problem"
  - slug: "interconnections"
    note: "Wicked problems are wicked because they're deeply interconnected - pulling one thread moves everything"
  - slug: "cynefin-framework"
    note: "Cynefin places wicked problems in the complex domain, where probe-sense-respond replaces analyse-and-plan"
  - slug: "complex-adaptive-systems"
    note: "Wicked problems arise from complex adaptive systems - the agents' responses to your solution become part of the problem"
  - slug: "irreducibility"
