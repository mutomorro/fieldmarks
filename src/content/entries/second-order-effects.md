...
oneLiner: "The consequences of the consequences - what happens after the first thing happens"
alsoKnownAs: ["Second-order thinking", "Downstream effects", "Knock-on effects"]
...
related:
  ...
  - slug: "delays"
    note: "Second-order effects are often hidden by delays - the first-order effect is visible now, the second-order one shows up later"
  - slug: "unintended-consequences"
    note: "Most unintended consequences are second- or third-order effects that weren't traced far enough forward"
  - slug: "nonlinearity"
    note: "Second-order effects can be wildly disproportionate to the first-order change that caused them"
  - slug: "exponential-growth"
    note: "Exponential growth is a second-order effect - the output of one cycle becomes the input of the next"
  - slug: "nudges"
    note: "Nudges can produce second-order effects - a single default change can shift behaviour patterns far beyond the original choice"
  - slug: "uncertainty-vs-risk"
    note: "Second-order effects are a major source of genuine uncertainty - the consequences of consequences resist prediction"
  - slug: "linear-thinking"
    note: "Linear thinking stops at the first-order effect and misses everything that follows"
draft: false
---
