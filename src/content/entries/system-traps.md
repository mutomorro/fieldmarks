---
title: "System Traps"
oneLiner: "Predictable structural failures that show up across every kind of system"
alsoKnownAs: ["System archetypes", "Structural traps"]
...
related:
  ...
  - slug: "shifting-the-burden"
    note: "Another classic trap - relying on the easy solution until the hard one becomes impossible"
  - slug: "eroding-goals"
    note: "The trap where standards slowly drop because closing the gap feels too hard"
  - slug: "tragedy-of-the-commons"
    note: "The trap where rational individual behaviour destroys the shared resource everyone depends on"
  - slug: "policy-resistance"
    note: "Understanding system traps helps explain why policy resistance occurs - you're fighting a structural pattern"
  - slug: "escalation"
    note: "The escalation trap - two parties ratcheting up responses to each other indefinitely"
  - slug: "catalytic-mechanisms"
    note: "Well-designed catalytic mechanisms can break system traps by changing the structural incentives that produce them"
  - slug: "constraints"
    note: "Adding an enabling constraint is often the escape route from a system trap"
