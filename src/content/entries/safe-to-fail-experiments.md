...
oneLiner: "Small probes designed to test how a complex system responds - if they fail, the damage is contained"
alsoKnownAs: ["Probes", "Safe-to-fail probes", "Small bets"]
...
related:
  ...
  - slug: "complexity-vs-complication"
    note: "Safe-to-fail is the right approach for complex problems where you can't predict the outcome in advance"
  - slug: "irreducibility"
    note: "Safe-to-fail respects irreducibility - if the only way to know is to try, make the trying safe"
  - slug: "antifragility"
