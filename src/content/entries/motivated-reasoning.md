...
oneLiner: "Finding the evidence for what you already believe - the human default, not the exception"
alsoKnownAs: ["Confirmation bias (active)", "Directional reasoning", "Belief-driven thinking"]
...
related:
  ...
  - slug: "feedback-loops"
    note: "Motivated reasoning creates a reinforcing loop - beliefs filter evidence, filtered evidence reinforces beliefs"
  - slug: "groupthink"
    note: "Groupthink amplifies motivated reasoning - the group's shared beliefs become even more resistant to disconfirming evidence"
  - slug: "double-loop-learning"
    note: "Double-loop learning is the antidote to motivated reasoning - deliberately questioning the assumptions that reasoning is protecting"
