...
oneLiner: "The practice of making a system visible - its parts, flows, boundaries, and dynamics"
alsoKnownAs: ["System maps", "Rich pictures", "Systemic mapping"]
theme: "mental-models"
...
related:
  ...
  - slug: "boundaries"
    note: "Every systems map requires a boundary decision - what's inside and what's outside the map"
  - slug: "interconnections"
    note: "Systems mapping exists to make interconnections visible - the relationships that produce the behaviour"
  - slug: "stocks-and-flows"
    note: "Stock and flow diagrams are another common systems mapping technique - tracking what accumulates and what moves"
  - slug: "mental-models"
