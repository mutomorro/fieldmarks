...
oneLiner: "When a system fights back against your attempt to change it"
alsoKnownAs: ["Pushback", "Systemic resistance"]
...
related:
  ...
  - slug: "fixes-that-fail"
    note: "Fixes that fail are often policy resistance in action - the system absorbs the fix and reasserts itself"
  - slug: "leverage-points"
    note: "Policy resistance is the sign you've hit a low-leverage point - the structure is stronger than your push"
  - slug: "unintended-consequences"
    note: "The system's resistance often manifests as unintended consequences that cancel out the intended ones"
  - slug: "shifting-the-burden"
    note: "When resistance makes a real solution too hard, the temptation is to shift the burden to something easier"
  - slug: "catalytic-mechanisms"
    note: "Catalytic mechanisms sidestep policy resistance by aligning interests rather than overriding them"
  - slug: "intervention-side-effects"
    note: "Policy resistance often shows up as intervention side effects - the system compensating for your push"
  - slug: "nudges"
    note: "Nudges often meet less resistance than mandates because they steer rather than force"
