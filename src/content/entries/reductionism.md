---
title: "Reductionism"
oneLiner: "Breaking things into parts to understand them - powerful for machines, misleading for living systems"
alsoKnownAs: ["Analytical thinking", "Decomposition"]
theme: "mental-models"
...
related:
  ...
  - slug: "emergence"
    note: "Emergence is what reductionism misses - the behaviour that exists only in the interaction between parts, not in the parts themselves"
  - slug: "sub-optimisation"
    note: "Sub-optimisation is reductionism in action - optimising each part separately and assuming the whole will improve"
  - slug: "interconnections"
    note: "Reductionism discards interconnections when it separates the parts - and the interconnections are often where the behaviour lives"
