...
oneLiner: "The places in a system where a small change can shift everything"
alsoKnownAs: ["Pressure points", "High-leverage interventions"]
theme: "leverage-and-intervention"
...
related:
  ...
  - slug: "stocks-and-flows"
    note: "Flows are low-leverage - easy to see but slow to shift. The rules governing flows are where the real leverage lives"
  - slug: "boundaries"
    note: "Redefining what's inside the system is a high-leverage move that changes everything downstream"
  - slug: "fixes-that-fail"
    note: "Most failed fixes target low-leverage points - adjusting numbers instead of changing structures"
  - slug: "interconnections"
    note: "The pattern of interconnections determines where leverage exists in a system"
  - slug: "catalytic-mechanisms"
    note: "Catalytic mechanisms are high-leverage by nature - small structural moves with outsized, self-sustaining effects"
  - slug: "second-order-effects"
    note: "Choosing the right leverage point requires second-order thinking - what happens after the first shift?"
  - slug: "intervention-side-effects"
    note: "Higher-leverage interventions can produce more powerful side effects - leverage amplifies everything, not just the intended effect"
  - slug: "nudges"
    note: "Nudges target a specific leverage point - the choice architecture that shapes individual decisions"
  - slug: "constraints"
    note: "Adding or removing a constraint can be a high-leverage move that reshapes what the whole system does"
  - slug: "requisite-variety"
    note: "Increasing your range of possible responses is itself a leverage point"
  - slug: "complexity-vs-complication"
    note: "In complicated systems, leverage points are findable through analysis. In complex ones, they shift and hide"
  - slug: "cynefin-framework"
    note: "Cynefin helps locate leverage by first identifying what kind of system you're dealing with"
  - slug: "mental-models"
    note: "Changing mental models is one of the highest leverage points in any system - near the top of Meadows' hierarchy"
  - slug: "iceberg-model"
