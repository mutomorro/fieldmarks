---
title: "Constraints"
oneLiner: "Limitations that shape behaviour - sometimes adding one creates better outcomes than removing one"
alsoKnownAs: ["Boundaries", "Limiting factors", "Enabling constraints"]
...
related:
  ...
  - slug: "buffers"
    note: "Buffers give you room to work within constraints - they're the slack that makes tight systems survivable"
  - slug: "leverage-points"
    note: "Adding or removing a constraint can be a high-leverage intervention - it reshapes what the system can do"
  - slug: "catalytic-mechanisms"
    note: "Many catalytic mechanisms work by introducing an enabling constraint that makes the desired behaviour the only path"
  - slug: "boundaries"
    note: "Constraints and boundaries are close relatives - both define what's inside and outside, what's possible and what isn't"
  - slug: "edge-of-chaos"
    note: "The right constraints hold a system at the edge of chaos - enough structure to function, enough freedom to adapt"
  - slug: "robustness-vs-resilience"
    note: "Robustness works by adding constraints that prevent change. Resilience works by maintaining flexibility to respond to it"
draft: false
---
