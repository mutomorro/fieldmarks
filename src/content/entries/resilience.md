---
title: "Resilience"
oneLiner: "The ability to absorb disturbance and still maintain essential function - not bouncing back, but holding together"
alsoKnownAs: ["Systemic resilience", "Adaptive resilience"]
...
related:
  ...
  - slug: "antifragility"
    note: "Antifragility goes beyond resilience - not just surviving shocks but getting stronger from them"
  - slug: "adaptive-capacity"
    note: "Adaptive capacity is the resource that makes resilience possible - the ability to adjust when things change"
  - slug: "buffers"
    note: "Buffers are a key source of resilience - the slack that absorbs shocks before they reach critical functions"
  - slug: "feedback-loops"
    note: "Resilient systems have feedback loops that detect disturbance early and trigger adaptation before damage compounds"
  - slug: "regime-shifts"
    note: "Regime shifts happen when resilience is exhausted - the system can no longer absorb disturbance and flips to a new state"
